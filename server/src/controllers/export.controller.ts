...
export const exportController = {
  async csv(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.setHeader('Content-Disposition', 'attachment; filename=mindbridge-mood-data.csv');
  ...
  async therapistSummary(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const summary = {
        ...
        disclaimer: 'This summary was generated by MindBridge and is intended to supplement, not replace, clinical assessment.',
      };
